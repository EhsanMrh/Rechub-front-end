...
import { etehadiye, namadha, logo } from 'Paths.js'
        ...
        <div className="footer section">
            <div className="footer__top">
                ...
                <div className="footer__license">
                    <img src={etehadiye} alt="اتحادیه کسب و کارهای دیجیتال" />
                    <img src={namadha} alt="" />
                </div>
            </div>
            <div className="footer__link">
                ...
                <p>
                    ...
                    <Link to="/panel/jobseeker">job</Link>
                    <Link to="/panel/immigrationoffice">office</Link>
                </p>
            </div>
        </div>
    )
